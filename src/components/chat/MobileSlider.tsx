  ...
  return (
    <div className="w-full flex items-center justify-center my-2">
      <div className="relative flex h-9 rounded-lg bg-[#F8F8F6] border border-[#E8E8E5] overflow-hidden select-none" style={{ width: 130 }}>
        ...
        {/* Chat button */}
        <button
          className={`h-full z-10 text-sm font-medium transition-colors duration-200 relative ${mode === 'chat' ? 'text-black font-semibold' : 'text-gray-500'} flex items-center justify-center`}
          style={{ width: 65 }}
        ...
        {/* Web button */}
        <button
          className={`h-full z-10 text-sm font-medium transition-colors duration-200 relative ${mode === 'research' ? 'text-black font-semibold' : 'text-gray-500'} flex items-center justify-center`}
          style={{ width: 65 }}
