...
const formSchema = z.object({
  ...
  model: z.enum(["gpt-4", "gpt-3.5-turbo", "perplexity", "claude", "deepseek", "gpt-4o"]),
  ...
  useEffect(() => {
    ...
    if (initialValues) {
      ...
      const formValues: FormValues = {
        ...
        model: "gpt-4o", // Always use gpt-4o for now
          ...
          <div style={{ 
            ...
            <div className="w-full">
              <div className="flex items-center gap-2">
                ...
                <span className="text-black opacity-70 bg-yellow-100 px-2 py-0.5 rounded-full text-xs">Will be available soon</span>
              </div>
                      ...
                      <div className="flex flex-wrap gap-4">
                        {[
                          { 
                            value: "perplexity", 
                            label: "Perplexity", 
                            icon: <PerplexityLogo className="h-4 w-4" />,
                            bgColor: "bg-[#1F1F1F]",
                          ...
                          { 
                            value: "gpt-4o", 
                            label: "GPT-4o", 
                            icon: <TriageAgentLogo className="h-4 w-4" />,
                          ...
                          { 
                            value: "claude", 
                            label: "Claude", 
                            icon: <ClaudeCreativeLogo className="h-4 w-4" />,
                            bgColor: "bg-[#D77655]",
                            description: "Great for questions about social media trends, viral content, and the latest news" 
                          },
                          { 
                            value: "deepseek", 
                            label: "Deepseek", 
                            icon: <DeepSeekLogo className="h-4 w-4" />,
                            bgColor: "bg-[#4D6BFE]",
                            description: "Great for questions about social media trends, viral content, and the latest news" 
                          }
                        ].map(model => (
                          ...
                          >
                            ...
                            <p className="text-black opacity-70 mt-1" style={{ fontSize: '14px', lineHeight: '20px' }}>{model.description}</p>
                          </div>
                        ))}
                      </div>
                    </FormItem>
                      ...
                      {AVAILABLE_TOOLS.map((tool) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <p className="text-black opacity-70 mt-1" style={{ fontSize: '14px', lineHeight: '20px' }}>
                              {tool.description}
                            </p>
                          </div>
                        );
